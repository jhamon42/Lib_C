...
/*   Updated: 2018/02/12 14:03:52 by jhamon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int	ft_color2(const char *balise, t_list *var)
{
	if (ft_strequ(balise, "{YELLOW"))
		return ((ft_memdel((void *)&balise) + ft_oke(YELLOW, var, 8)));
	else if (ft_strequ(balise, "{CYAN"))
		return ((ft_memdel((void *)&balise) + ft_oke(CYAN, var, 6)));
	return ((ft_memdel((void *)&balise) + ft_copyinbuff('{', var)));
}
...
int			ft_color(const char *format, t_list *var)
{
	...
	if (ft_strequ(balise, "{EOC"))
		return ((ft_memdel((void *)&balise) + ft_oke(EOC, var, 5)));
	else if (ft_strequ(balise, "{BLUE"))
		return ((ft_memdel((void *)&balise) + ft_oke(BLUE, var, 6)));
	else if (ft_strequ(balise, "{BLACK"))
		return ((ft_memdel((void *)&balise) + ft_oke(BLACK, var, 7)));
	else if (ft_strequ(balise, "{GREEN"))
		return ((ft_memdel((void *)&balise) + ft_oke(GREEN, var, 7)));
	else if (ft_strequ(balise, "{GREY"))
		return ((ft_memdel((void *)&balise) + ft_oke(GREY, var, 6)));
	else if (ft_strequ(balise, "{PURPLE"))
		return ((ft_memdel((void *)&balise) + ft_oke(PURPLE, var, 8)));
	else if (ft_strequ(balise, "{RED"))
		return ((ft_memdel((void *)&balise) + ft_oke(RED, var, 5)));
